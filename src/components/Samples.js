  ...
  return (
    <div id="testsample">
      <div class="section-content">
        <h2 id="TestSamples">Samples</h2>
        <div class="mc-container">
          <div class="mc-box">
            <h3>Fixed page size samples</h3>

            <h4>Japanese novel “Gon, the Little Fox”</h4>
            <p>
              <a
            ...
            <h4>Japanese multi-column magazine “Mt. Shirouma”</h4>
            <p>
              <a
            ...
            <h4>Web fonts sample “Wood Engraving”</h4>
            <dl class="file-link">
              <dt>with justification and hyphenation</dt>
              <dd>
                <a
              ...
              <dt>without justification and hyphenation</dt>
              <dd>
                <a
          ...
          <div class="mc-box">
            <h3>Variable page size samples</h3>

            <h4>“The Malay Archipelago”</h4>
            <p>
              <a
            ...
            <h4>Japanese, Horizontal writing mode “Takasebune”</h4>
            <p>
              <a
            ...
            <h4>Japanese, Vertical writing mode “Takasebune”</h4>
            <p>
              <a
        ...
        <ul class="note">
          <li>
            <b>Page/Spread View</b> for auto spread paginated view with online
            Vivliostyle Viewer.
          </li>
          <li>
            <b>Page View</b> for single page paginated view with online
            Vivliostyle Viewer.
          </li>
          <li>
            <b>Spread View</b> for spread paginated view with online Vivliostyle
            Viewer.
          </li>
          <li>
            <b>Raw HTML</b> for normal HTML view.
          </li>
          <li>
            <b>Source</b> for source files, HTML+CSS etc., on GitHub.
          </li>
        </ul>
        ...
        <p>
          You can find other samples at{" "}
          <a href="/samples/">Vivliostyle Samples</a>.
        </p>
      </div>
    </div>
  );
